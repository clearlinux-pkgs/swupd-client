...
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v5.0.1/swupd-client-5.0.1.tar.gz
...
%prep
%setup -q -n swupd-client-5.0.1
cd %{_builddir}/swupd-client-5.0.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677867620
