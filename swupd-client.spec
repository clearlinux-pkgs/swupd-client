...
Version  : 4.1.0
Release  : 338
URL      : https://github.com/clearlinux/swupd-client/releases/download/v4.1.0/swupd-client-4.1.0.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v4.1.0/swupd-client-4.1.0.tar.gz
...
Patch2: 0001-config-CONFIG_FILE_PATH-shouldn-t-be-treated-as-a-pa.patch
...
%prep
%setup -q -n swupd-client-4.1.0
cd %{_builddir}/swupd-client-4.1.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589299063
...
cp %{_builddir}/swupd-client-4.1.0/COPYING %{buildroot}/usr/share/package-licenses/swupd-client/f5b8c6b890f2c7664954577396afb1fed9aa550f
%make_install
