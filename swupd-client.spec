...
Version  : 5.0.0
Release  : 362
URL      : https://github.com/clearlinux/swupd-client/releases/download/v5.0.0/swupd-client-5.0.0.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v5.0.0/swupd-client-5.0.0.tar.gz
...
%prep
%setup -q -n swupd-client-5.0.0
cd %{_builddir}/swupd-client-5.0.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677794239
