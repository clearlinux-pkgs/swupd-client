...
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.24.5/swupd-client-3.24.5.tar.gz
...
%prep
%setup -q -n swupd-client-3.24.5
cd %{_builddir}/swupd-client-3.24.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586463073
...
cp %{_builddir}/swupd-client-3.24.5/COPYING %{buildroot}/usr/share/package-licenses/swupd-client/f5b8c6b890f2c7664954577396afb1fed9aa550f
%make_install
