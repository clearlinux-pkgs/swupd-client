...
Patch10: 0001-Add-option-for-os-install-to-specify-arch.patch
Patch11: backport-Check-for-rst2man-or-rst2man.py.patch
Patch12: backport-Redirect-URL-override-messages-to-STDERR.patch
...
%prep
%setup -q -n swupd-client-5.1.0
cd %{_builddir}/swupd-client-5.1.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724705104
