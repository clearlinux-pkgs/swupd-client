...
Version  : 6.1.0
Release  : 402
URL      : https://github.com/clearlinux/swupd-client/releases/download/v6.1.0/swupd-client-6.1.0.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v6.1.0/swupd-client-6.1.0.tar.gz
...
%prep
%setup -q -n swupd-client-6.1.0
cd %{_builddir}/swupd-client-6.1.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
%patch -P 10 -p1
pushd ..
cp -a swupd-client-6.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743110962
