...
Version  : 3.24.2
Release  : 332
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.24.2/swupd-client-3.24.2.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.24.2/swupd-client-3.24.2.tar.gz
...
%prep
%setup -q -n swupd-client-3.24.2
cd %{_builddir}/swupd-client-3.24.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584123683
...
cp %{_builddir}/swupd-client-3.24.2/COPYING %{buildroot}/usr/share/package-licenses/swupd-client/f5b8c6b890f2c7664954577396afb1fed9aa550f
%make_install
